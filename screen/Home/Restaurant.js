...
const Restaurant = ({route, navigation}) => {
    ...
    const requestPostingReview = async () => {
        const response = await postReview(writingReviewContent, writingReviewGrade, restaurantId);
                    ...
                    >
                        <ReviewWritingPanel>
                            ...
                            <TouchableStarMakerHolder>
                                <TouchableStarMaker setGrade={setWritingReviewGrade} size={45} iconSizeRatio={80}/>
                            </TouchableStarMakerHolder>
                            <TextInput
                                mode="none"
